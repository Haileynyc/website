      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="flex-row custom-nav">
          ...
          <Nav.Link href="/#experience">
            <span className="navlink">Design Experience</span>
          </Nav.Link>
          <Nav.Link href="/#clubs">
            <span className="navlink">Clubs/Orgs</span>
          </Nav.Link>
          <Nav.Link href="/#coursework">
            <span className="navlink">Coursework</span>
          </Nav.Link>
          <Nav.Link href="/#skills">
            <span className="navlink">Skills</span>
          </Nav.Link>
          <Nav.Link href="/#work">
            <span className="navlink">Work Experience</span>
          </Nav.Link>
